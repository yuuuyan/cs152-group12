...
import pandas as pd
import numpy as np
from datasets import MisinformationDataset
from sklearn.model_selection import train_test_split


dataset = MisinformationDataset(true_filepath="./Datasets/DataSet_Misinfo_TRUE.csv", false_filepath="./Datasets/DataSet_Misinfo_FAKE.csv")
